...
//Answer:
// Attributes: You can change attributes like src, href, class, etc.
// Styles: You can modify the CSS styles directly.
// Classes: You can add, remove, or toggle classes.
// Visibility: You can show or hide elements.
// Event Listeners: You can attach event handlers to elements.
// Creating Elements: You can create new HTML elements and append them to the DOM.
 ...
 * ↓ YOUR CODE HERE ↓ */
   ...
   letmyTdName = document.createElement('td')
   letmyTdEmail = document.createElement('td')
...
//Answer: mousemove, mouseover, mouseup, mousedown, scroll
